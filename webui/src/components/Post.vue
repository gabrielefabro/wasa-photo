...
export default {
	...
	props: ['owner','likes','comments',"upload_date","postID","isOwner"], 
	...
	methods:{
		...
		async deletePost(){
			try{
				...
				// location.reload()
				this.$emit("removePost",this.postID)
			}catch(e){
				//
			}
		},

		postOwnerClick: function(){
        ...
        <div class="d-flex flex-row justify-content-center">
            ...
            <div class="card my-card">
                <div class="d-flex justify-content-end">
                    ...
                    <button v-if="isOwner" class="my-trnsp-btn my-dlt-btn me-2" @click="deletePost">
						<!--Delete-->
						<i class="fa-solid fa-trash w-100 h-100"></i>
					</button>

                </div>
                <div class="d-flex justify-content-center post-background-color">
                    <img :src="postURL" class="card-img-top img-fluid">
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="container">
                        ...
                        <div class="d-flex flex-row justify-content-end align-items-center mb-2">
							...
							<button class="my-trnsp-btn m-0 p-1 me-auto" @click="postOwnerClick">
                            	<i> From {{owner}}</i>
							</button>
